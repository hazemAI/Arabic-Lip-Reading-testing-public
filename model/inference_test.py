...
class VideoDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for i in range(cnt):
            ...
            start = (96 - 88) // 2
            cropped = resized[start:start+88, start:start+88]
            pil = Image.fromarray(cropped, 'L')
            if self.transform:
...
if __name__=='__main__':
    ...
    parser.add_argument('--test_dir', default=os.path.join(os.getcwd(), 'Arabic-Lip-Reading-testing-public', 'Additional', 'Videos'))
    parser.add_argument('--csv_dir', default=os.path.join(os.getcwd(), 'Arabic-Lip-Reading-testing-public', 'Additional', 'CSV'))
